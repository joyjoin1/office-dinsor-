...
<head>
    ...
    height: 20px; /* ปรับขนาดความสูงตามที่คุณต้องการ */
    }
    ...
    .status[data-status="คืนแล้ว"] {
        background-color: #5258FA; /* Orange-Yellow color for กำลังใช้งาน สีส้มเหลือง */
        color: white;
    }
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>10/02/2567</td>
                <td>17/02/2567</td>
                <td class="status" data-status="คืนแล้ว">คืนแล้ว</td>
            </tr>
